...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getcategories = function getcategories() {
    ...
    // ))}
    for (var expensesss in this.props.testprop) {
      if (expensesss.description == "Breakfast") {
        console.log(expensesss.description);
      }
    }
  };
...
//# sourceMappingURL=projections-ffd7e81f23d9dc76df40.js.map