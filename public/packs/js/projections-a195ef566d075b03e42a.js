...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getAverageVariationPerMonth = function getAverageVariationPerMonth() {
    for (var i = this.state.totalPerMonth.length - 2; i > -1; i--) {
      this.state.variationPerMonth[i] = 0;
    ...
    console.log(sum / this.state.variationPerMonth.length); // 6
    //this.state.averageVariationPerMonth = 
  };
...
//# sourceMappingURL=projections-a195ef566d075b03e42a.js.map