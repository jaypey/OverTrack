...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.urlExpenses = function urlExpenses() {
    return "/revenues?include_category=true&paid_before=" + this.state.maxPaidAtExpense + "&paid_after=" + this.state.minPaidAtExpense + "&category_id=" + this.state.categoryId + "&sort=" + this.state.sort + "&sort_desc=" + this.state.sortDesc + "&search=" + this.state.search;
  ...
  _proto.renderItem = function renderItem(item) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", (_React$createElement49 = {
      ...
      onChange: function onChange(val) {
        return _this4.updateExpense(item.id, {
          paid_at: val
        });
      },
      value: new Date(item.paid_at),
      ...
      onClick: function onClick() {
        return _this4.handleExpenseDelete(item.id);
      },
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement50 = {
      ...
      lineNumber: 287,
      columnNumber: 7
    }, _React$createElement50), this.renderEmptyState(), this.renderExpensesTable());
  };
...
//# sourceMappingURL=history-177627c4338fcaca8b9c.js.map