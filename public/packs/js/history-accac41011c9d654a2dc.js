...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.urlExpenses = function urlExpenses() {
    return "/expenses?include_category=true&paid_before=" + this.state.maxPaidAtExpense + "&paid_after=" + this.state.minPaidAtExpense + "&category_id=" + this.state.categoryIdExpenses + "&sort=" + this.state.sortRevenues + "&sort_desc=" + this.state.sortDesc + "&search=" + this.state.searchExpenses;
...
//# sourceMappingURL=history-accac41011c9d654a2dc.js.map