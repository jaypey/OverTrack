...
var Revenues = {
  list: function list(params) {
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.get('/revenues/index', params, opts || {});
  },
  create: function create(data, opts) {
    if (opts === void 0) {
      opts = {};
    ...
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.post('/revenues/create', data, opts || {});
  },
  "delete": function _delete(id, params, opts) {
    if (opts === void 0) {
      opts = {};
    ...
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.delete("/revenues/destroy" + id, params, opts || {});
  },
  update: function update(id, data, opts) {
    if (opts === void 0) {
      opts = {};
    ...
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.put("/revenues/update" + id, data, opts || {});
  }
};
...
//# sourceMappingURL=app_javascript_api_main_js-app_javascript_helpers_main_js-node_modules_moment_locale_sync_rec-f85292-c7e4db34d84619f133e5.js.map