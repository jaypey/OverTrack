...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.calculateNumber = function (spend, revenues) {
    ...
    _this.loadPieChartData = function (month) {
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Reports.month({
        ...
        var data = resp.category_pourcentage.map(function (r) {
          return _this.calculateNumber(r.spend, revenue);
        });

        if (data.length === 0) {
          ['gray'], _readOnlyError("colors");
          ['Empty'], _readOnlyError("labels");
          [100.000], _readOnlyError("data");
        }
        ...
        console.log("Supposedly saved colors: " + colors + " Supposedly saved data: " + data + " Supposedly saved labels: " + labels);
        console.log("Dashboard saved colors: " + _this.state.colors + " Dashboard saved data: " + _this.state.data + " Dashboard saved labels: " + _this.state.labels);
        return true;
      }, function () {
...
var PieChart = function PieChart(_ref) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    instance == null ? void 0 : instance.destroy(); // For testing

    console.log('PieChart colors: ' + colors + ' PieChart data: ' + data + ' PieChart labels: ' + labels);
    console.log('');
    var config = {
      type: 'pie',
      data: {
...
//# sourceMappingURL=dashboard-2f244d32e7efdc0150d6.js.map