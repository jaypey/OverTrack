  ...
  function Main(props) {
    ...
    _this.loadPieChartData = function (month) {
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Reports.month({
        ...
        data = resp.category_totals.map(function (r) {
          return (r.spend / revenue).toFixed(2);
        });
        data.push(other);
        labels = resp.category_totals.map(function (r) {
          return r.category;
        });
        labels.push("revenues");
        colors = resp.category_totals.map(function (r) {
          return r.color;
        });
        colors.push("#808080");
...
//# sourceMappingURL=dashboard-2ccc83d267b2f5e3c597.js.map