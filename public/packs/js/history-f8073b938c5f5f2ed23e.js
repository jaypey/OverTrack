...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.urlRevenues = function urlRevenues() {
    return "/revenues?include_category=true&paid_before=" + this.state.maxPaidAtRevenue + "&paid_after=" + this.state.minPaidAtRevenue + "&category_id=" + this.state.categoryIdRevenues + "&search=" + this.state.search;
  };
...
//# sourceMappingURL=history-f8073b938c5f5f2ed23e.js.map