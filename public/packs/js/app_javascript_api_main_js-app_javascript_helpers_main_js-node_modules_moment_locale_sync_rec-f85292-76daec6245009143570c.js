...
var Categories = {
  ...
  listCategoryExpenses: function listCategoryExpenses(params, opts) {
    if (opts === void 0) {
      opts = {};
    }

    return _base__WEBPACK_IMPORTED_MODULE_0__.default.get('/categories/listCategoryExpenses', params, opts || {});
  },
  listCategoryRevenues: function listCategoryRevenues(params, opts) {
    if (opts === void 0) {
      opts = {};
    }

    return _base__WEBPACK_IMPORTED_MODULE_0__.default.get('/categories/listCategoryRevenues', params, opts || {});
  },
...
//# sourceMappingURL=app_javascript_api_main_js-app_javascript_helpers_main_js-node_modules_moment_locale_sync_rec-f85292-76daec6245009143570c.js.map