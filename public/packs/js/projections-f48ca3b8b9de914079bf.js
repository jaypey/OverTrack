...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement10 = {
      ...
      lineNumber: 141,
      columnNumber: 9
    }, _React$createElement5), "Decrease projected months"), this.state.project < 3 && this.state.project.setState({
      project: this.state.project + 1
    }), this.state.project > 12 && this.state.project.setState({
      project: this.state.project - 1
    }), this.state.count < 3 && this.state.count.setState({
      count: this.state.count + 1
    }), this.state.count > 12 && this.state.count.setState({
      count: this.state.count - 1
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", (_React$createElement6 = {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 148,
...
//# sourceMappingURL=projections-f48ca3b8b9de914079bf.js.map