...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.getTotalRevenue = function () {
      var totalRevenue = 0;
    ...
    _this.getTotalExpense = function () {
      var totalExpense = 0;

      _this.state.categories.forEach(function (category) {
        if (category.is_revenue == 0) {
          category.expenses = _this.state.expenses.filter(function (expense) {
    ...
    _this.loadSum = function () {
      var totalExpense = _this.getTotalExpense();

      var totalRevenue = _this.getTotalRevenue();
...
//# sourceMappingURL=dashboard-dd69de6afbd69d3c9a30.js.map