...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getDistinctExpenses = function getDistinctExpenses() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(this.state.distinctExpenses), _step; !(_step = _iterator()).done;) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement2 = {
      ...
      lineNumber: 88,
      columnNumber: 5
    }, _React$createElement2), this.state.distinctExpenses.map(function (expense) {
      var _React$createElement;
...
//# sourceMappingURL=projections-98ee51a43db3f17d15fe.js.map