...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.loadExpensesData = function () {
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Categories.listCategoryExpenses().then(function (cResp) {
        _this.setState({
          eCategories: cResp
        });
  ...
  _proto.categoriesWithExpensesAndSpend = function categoriesWithExpensesAndSpend() {
    ...
    var categories = [];
    this.state.eCategories.forEach(function (category) {
  ...
  _proto.renderExpenseCreateModal = function renderExpenseCreateModal() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_expenses_FormModal__WEBPACK_IMPORTED_MODULE_4__.default, (_React$createElement = {
      categories: this.state.eCategories,
  ...
  /*loadRevenueData = () => {
    Categories.listCategoryRevenues().then(
      (cResp) => {
        this.setState({ rCategories: cResp });
          Revenues.index({ paid_after: moment().startOf('month').unix() }).then(
          (rResp) => {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement11 = {
      ...
      onChange: this.loadExpensesData,
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 92,
...
//# sourceMappingURL=dashboard-4fcad3800ab1b7120a20.js.map