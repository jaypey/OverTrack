  ...
  function Main(props) {
    ...
    _this.loadPieChartData = function (month) {
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Reports.month({
        ...
        var data = resp.category_totals.map(function (r) {
          return (r.spend / revenue).toFixed(5);
        });
        var labels = resp.category_totals.map(function (r) {
          return r.category;
        });
        var colors = resp.category_totals.map(function (r) {
          return r.color;
        });
        var newData = resp.revenues_totals.map(function (r) {
          return (r.spend / revenue).toFixed(5);
        });
        var newLabels = resp.revenues_totals.map(function (r) {
          return r.category;
        });
        var newColors = resp.revenues_totals.map(function (r) {
          return r.color;
        });
...
//# sourceMappingURL=dashboard-5d273d95d7db7bd254fe.js.map