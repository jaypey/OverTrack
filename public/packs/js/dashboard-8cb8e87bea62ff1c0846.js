  ...
  function Main(props) {
    ...
    _this.loadPieChartData = function (month) {
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Reports.month({
        ...
        var expenseTotal = 100;
        resp.category_totals.forEach(function (r) {
          other - r.spend / revenue, _readOnlyError("other");
        });
        others[0].data.push(expenseTotal);
        var data = resp.category_totals.map(function (r) {
          return (r.spend / revenue).toFixed(2);
        });
...
//# sourceMappingURL=dashboard-8cb8e87bea62ff1c0846.js.map