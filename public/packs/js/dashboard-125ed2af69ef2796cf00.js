...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.loadSumRevenue = function loadSumRevenue() {
    var index = 0;
    this.state.revenues.forEach(function (item) {
      index += item.amount;
    });
    this.setState({
      sumRevenues: index
  ...
  _proto.loadSumExpenses = function loadSumExpenses() {
    var index = 0;
...
//# sourceMappingURL=dashboard-125ed2af69ef2796cf00.js.map