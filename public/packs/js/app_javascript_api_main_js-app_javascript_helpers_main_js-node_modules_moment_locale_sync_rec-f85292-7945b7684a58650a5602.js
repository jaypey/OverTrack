...
var Revenues = {
  ...
  bulkCreate: function bulkCreate(data, opts) {
    ...
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.post('/revenues/bulk_create', data, opts || {});
  },
  "delete": function _delete(id, params, opts) {
    if (opts === void 0) {
      opts = {};
...
//# sourceMappingURL=app_javascript_api_main_js-app_javascript_helpers_main_js-node_modules_moment_locale_sync_rec-f85292-7945b7684a58650a5602.js.map