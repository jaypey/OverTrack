...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.minAndMaxForTimeframe = function (timeframe) {
      switch (timeframe) {
        ...
        case 'custom':
          return [_this.state.minPaidAtExpense, _this.state.maxPaidAt];
      }
    };
  ...
  _proto.url = function url() {
    return "/expenses?include_category=true&paid_before=" + this.state.maxPaidAt + "&paid_after=" + this.state.minPaidAtExpense + "&category_id=" + this.state.categoryId + "&sort=" + this.state.sort + "&sort_desc=" + this.state.sortDesc + "&search=" + this.state.search;
  };
...
//# sourceMappingURL=history-dbe23484609803be6cee.js.map