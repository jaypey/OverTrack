...
var UploadPreview = /*#__PURE__*/function (_React$Component) {
  ...
  function UploadPreview(props) {
    ...
    _this.submit = function () {
      ...
      _this.state.expenses.map(function (data) {
        if (data.is_spend) submittedExpenses.push(data);else submittedRevenues.push(data);
      });

      console.log(submittedExpenses);
      console.log(submittedRevenues);
      _api_main__WEBPACK_IMPORTED_MODULE_4__.Expenses.bulkCreate({
        expenses: _this.state.expenses.where('is_spend', true)
      }).then(_api_main__WEBPACK_IMPORTED_MODULE_4__.Revenues.bulkCreate({
        revenues: _this.state.expenses.where('is_spend', false)
      }).then(function () {
        _this.setState({
          submitting: false
        });
...
//# sourceMappingURL=upload_preview-f43497a30bf744a53404.js.map