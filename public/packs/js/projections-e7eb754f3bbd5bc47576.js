...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var monthNames = ["January " + currentTime.getFullYear().toString(), "February " + currentTime.getFullYear().toString(), "March " + currentTime.getFullYear().toString(), "April " + currentTime.getFullYear().toString(), "May " + currentTime.getFullYear().toString(), "June " + currentTime.getFullYear().toString(), "July " + currentTime.getFullYear().toString(), "August " + currentTime.getFullYear().toString(), "September " + currentTime.getFullYear().toString(), "October " + currentTime.getFullYear().toString(), "November " + currentTime.getFullYear().toString(), "December " + currentTime.getFullYear().toString(), "January " + (currentTime.getFullYear() + 1).toString(), "February " + (currentTime.getFullYear() + 1).toString(), "March " + (currentTime.getFullYear() + 1).toString(), "April " + (currentTime.getFullYear() + 1).toString(), "May " + (currentTime.getFullYear() + 1).toString(), "June " + (currentTime.getFullYear() + 1).toString(), "July " + (currentTime.getFullYear() + 1).toString(), "August " + (currentTime.getFullYear() + 1).toString(), "September " + (currentTime.getFullYear() + 1).toString(), "October " + (currentTime.getFullYear() + 1).toString(), "November " + (currentTime.getFullYear() + 1).toString(), "December " + (currentTime.getFullYear() + 1).toString()];
    monthNames[-1] = "December " + (currentTime.getFullYear() - 1).toString();
    monthNames[-2] = "November " + (currentTime.getFullYear() - 1).toString();
    monthNames[-3] = "October " + (currentTime.getFullYear() - 1).toString();
    monthNames[-4] = "September " + (currentTime.getFullYear() - 1).toString();
    monthNames[-5] = "August " + (currentTime.getFullYear() - 1).toString();
    monthNames[-6] = "July " + (currentTime.getFullYear() - 1).toString();
    monthNames[-7] = "June " + (currentTime.getFullYear() - 1).toString();
    monthNames[-8] = "May " + (currentTime.getFullYear() - 1).toString();
    monthNames[-9] = "April " + (currentTime.getFullYear() - 1).toString();
    monthNames[-10] = "March " + (currentTime.getFullYear() - 1).toString();
    monthNames[-11] = "February " + (currentTime.getFullYear() - 1).toString();
    monthNames[-12] = "January " + (currentTime.getFullYear() - 1).toString();
...
//# sourceMappingURL=projections-e7eb754f3bbd5bc47576.js.map