  ...
  function CreateConfig(props) {
    ...
    _this.onSave = function (response) {
      if (response.id != null) {
        ...
        _this.window.location.href("/expense_uploads/new");
      } else {
        _helpers_main__WEBPACK_IMPORTED_MODULE_4__.Alerts.error("There was an error when saving the config");
      }
    };
...
//# sourceMappingURL=create_config-441c3425e7acbbe25033.js.map