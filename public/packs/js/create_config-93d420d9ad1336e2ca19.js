...
var CreateConfig = /*#__PURE__*/function (_React$Component) {
  ...
  function CreateConfig(props) {
    ...
    _this.handleAddSubstring = function () {
      ...
      if (currentString !== undefined && currentString != "" && _this.state !== undefined) {
  ...
  _proto.handleRemoveSubstring = function handleRemoveSubstring(substringToDelete) {
    ...
    console.log(substringToDelete);
    if (stringToDelete !== undefined && stringToDelete != "" && this.state !== undefined) this.setState({
...
var GenericListItem = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement3 = {
      ...
      onClick: this.props.handleDelete(this.props.text),
...
//# sourceMappingURL=create_config-93d420d9ad1336e2ca19.js.map