...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement10 = {
      ...
      lineNumber: 141,
      columnNumber: 9
    }, _React$createElement5), "Decrease projected months"), this.state.project < 3 && this.setState({
      project: this.state.project + 1
    }), this.state.project > 12 && this.setState({
      project: this.state.project - 1
    }), this.state.count < 3 && this.setState({
      count: this.state.count + 1
    }), this.state.count > 12 && this.setState({
      count: this.state.count - 1
...
//# sourceMappingURL=projections-ef1a801fb121220fd9d1.js.map