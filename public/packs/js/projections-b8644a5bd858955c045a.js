...
/* harmony import */ var _ProjectionsChart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ProjectionsChart */ "./app/javascript/components/projections/ProjectionsChart.jsx");
...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.reloadData = function () {
      ...
      _this.loadPieChartData(moment__WEBPACK_IMPORTED_MODULE_2___default()().format('MMMM YYYY'));
    };
    ...
    _this.loadCategory = function () {
      _api_main__WEBPACK_IMPORTED_MODULE_4__.Categories.list().then(function (cResp) {
        ...
        _helpers_main__WEBPACK_IMPORTED_MODULE_5__.Alerts.error("Categories didn't load correctly");
      });
    };

    _this.loadExpensesData = function () {
      _api_main__WEBPACK_IMPORTED_MODULE_4__.Expenses.list().then(function (eResp) {
        _this.setState({
          expenses: eResp
        });
        ...
        _api_main__WEBPACK_IMPORTED_MODULE_4__.Goals.list().then(function (gResp) {
          ...
          _helpers_main__WEBPACK_IMPORTED_MODULE_5__.Alerts.error("Goal of expenses didn't load!");
        });
      }, function () {
        _helpers_main__WEBPACK_IMPORTED_MODULE_5__.Alerts.error("Expenses didn't load correctly!");
      });
    };

    _this.loadRevenueData = function () {
      _api_main__WEBPACK_IMPORTED_MODULE_4__.Revenues.list({
        paid_after: moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf('month').unix()
      }).then(function (rResp) {
        _this.setState({
          revenues: rResp
        });
      }, function () {
        _helpers_main__WEBPACK_IMPORTED_MODULE_5__.Alerts.error("Revenues didn't load correctly!");
      });
    };
    ...
    _this.loadPieChartData = function (month) {
      _api_main__WEBPACK_IMPORTED_MODULE_4__.Reports.month({
        ...
        _helpers_main__WEBPACK_IMPORTED_MODULE_5__.Alerts.error("The data for the pie chart didn't load correctly!");
      });
    };
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement7 = {
      ...
      lineNumber: 131,
      columnNumber: 7
    }, _React$createElement7), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'react-native'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (_React$createElement2 = {
      style: {
        height: 40
      },
      ...
      lineNumber: 132,
      columnNumber: 9
    }, _React$createElement2)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", (_React$createElement3 = {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 138,
      ...
      lineNumber: 138,
      columnNumber: 9
    }, _React$createElement3), "Predictions for the next few months"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("br", (_React$createElement4 = {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 139,
      ...
      lineNumber: 139,
      columnNumber: 9
    }, _React$createElement4)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("br", (_React$createElement5 = {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 140,
      ...
      lineNumber: 140,
      columnNumber: 9
    }, _React$createElement5)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ProjectionsChart__WEBPACK_IMPORTED_MODULE_6__.default, (_React$createElement6 = {
...
//# sourceMappingURL=projections-b8644a5bd858955c045a.js.map