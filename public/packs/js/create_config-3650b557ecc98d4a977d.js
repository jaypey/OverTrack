...
var CreateConfig = /*#__PURE__*/function (_React$Component) {
  ...
  function CreateConfig(props) {
    ...
    _this.handleAddSubstring = function () {
      console.log(_this.state.ignoredSubstring);

      _this.setState(function (prevState) {
        return {
          ignoredSubstring: [].concat(prevState.ignoredSubstring.filter(function (e) {
            return e !== _this.state.currentSubstring;
          }), _this.state.currentSubstring).sort()
        };
      });
  ...
  _proto.handleRemoveSubstring = function handleRemoveSubstring() {
    ...
    this.setState({
      ignoredSubstring: this.state.ignoredSubstring.filter(function (e) {
        return e !== _this2.state.currentSubstring;
      })
    });
  };
...
var GenericList = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, this.state.list.map(function (item, index) {
      var _React$createElement;
...
//# sourceMappingURL=create_config-3650b557ecc98d4a977d.js.map