...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getexpenseslastmonth = function getexpenseslastmonth() {
    ...
    // })))}
    {
      this.props.testprops.map(function (expense) {
        ...
        if (_this2.state.expenseslastmonth.filter(function (e) {
          return e.id === expense.id;
        }).length == 0) {
          _this2.setState(function (prevState) {
            return {
              expenseslastmonth: [].concat(prevState.expenseslastmonth, [expense])
            };
          });
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement3 = {
      ...
      lineNumber: 80,
      columnNumber: 9
    }, _React$createElement), "Hello test ", this.props.str), this.state.expenseslastmonth.map(function (expense) {
...
//# sourceMappingURL=projections-d2d16990e9910269bd72.js.map