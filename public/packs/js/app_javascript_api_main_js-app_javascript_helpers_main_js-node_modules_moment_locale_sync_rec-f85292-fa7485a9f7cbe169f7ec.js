...
var Revenues = {
  ...
  "delete": function _delete(id, params, opts) {
    ...
    return _base__WEBPACK_IMPORTED_MODULE_0__.default.delete("/revenues/delete/" + id, params, opts || {});
  },
  update: function update(id, data, opts) {
    if (opts === void 0) {
      opts = {};
...
//# sourceMappingURL=app_javascript_api_main_js-app_javascript_helpers_main_js-node_modules_moment_locale_sync_rec-f85292-fa7485a9f7cbe169f7ec.js.map