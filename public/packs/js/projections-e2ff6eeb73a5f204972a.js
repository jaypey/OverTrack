  ...
  _proto.getexpenseslastmonth = function getexpenseslastmonth() {
    {
      this.props.categoriesWithExpensesAndSpend.map(function (category) {
        return category.expenses.map(function (expense) {
          ...
          var paidMonth = new Date(expense.paid_at);
          console.log(expense.paid_at);
          console.log(currentMonth);
          console.log(paidMonth);
          console.log(expense.description); //console.log(typeof expense.paid_at);
...
//# sourceMappingURL=projections-e2ff6eeb73a5f204972a.js.map