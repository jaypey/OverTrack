...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.loadPieChartData = function (_ref) {
      ...
      _api_main__WEBPACK_IMPORTED_MODULE_6__.Reports.month({
        ...
        var labels = resp.category_totals.map(function (r) {
          return r.category;
        }); //const colors = resp.category_totals.map((r) => r.color);

        /*resp.category_totals.forEach((r) => {
          datasets.data.push((r.spend/revenue));
...
//# sourceMappingURL=dashboard-86f55442844bbfbaaba5.js.map