...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getcategories = function getcategories() {
    // {this.props.testprop.map(category => (
    //   console.log(category.name)
    // ))}
    for (var _iterator = _createForOfIteratorHelperLoose(this.props.categoriesWithExpensesAndSpend), _step; !(_step = _iterator()).done;) {
      var expensesss = _step.value;
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement3 = {
      ...
      lineNumber: 49,
      columnNumber: 9
    }, _React$createElement), "Hello test ", this.props.str), this.state.expensestest.map(function (expense) {
...
//# sourceMappingURL=projections-acd53ae1062009bcbdd5.js.map