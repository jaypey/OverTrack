...
var CategoryTile = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.goalComparisonDisplay = function goalComparisonDisplay() {
    ...
    return diff > 0 ? _helpers_main__WEBPACK_IMPORTED_MODULE_2__.Numerics.centsToDollars(Math.abs(diff)) + " over" : this.props.categoryWithExpensesAndSpend.is_revenue == 1 ? _helpers_main__WEBPACK_IMPORTED_MODULE_2__.Numerics.centsToDollars(diff) + " under" : _helpers_main__WEBPACK_IMPORTED_MODULE_2__.Numerics.centsToDollars(diff) + " remaining"; //return (diff >= 0) ? `${Numerics.centsToDollars(diff)} remaining` : `${Numerics.centsToDollars(Math.abs(diff))} over`;
  };
...
//# sourceMappingURL=dashboard-ccc8d902085b78c649b3.js.map