...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.urlRevenues = function urlRevenues() {
    return "/revenues?include_category=true&paid_before=" + this.state.maxPaidAtExpense + "&paid_after=" + this.state.minPaidAtExpense + "&category_id=" + this.state.categoryId + "&sort=" + this.state.sort + "&sort_desc=" + this.state.sortDesc;
  };
...
//# sourceMappingURL=history-18e6a6f12c8b01ebe2c6.js.map