...
var ProjectionsChart = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getDistinctExpenses = function getDistinctExpenses() {
    ...
    {
      this.props.testprops.map(function (expense) {
  ...
  _proto.getTotalMonthlyChangePrediction = function getTotalMonthlyChangePrediction() {
    ...
    for (var i = 0; i < 5; i++) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(this.state.distinctExpenses), _step2; !(_step2 = _iterator2()).done;) {
        var expense = _step2.value;
        var d = new Date(expense.paid_at);
        var currentTime = new Date();

        if (d.getMonth() == currentTime.getMonth() - 1 - i) {
          totalPerMonth[i] += expense.amount;
        }
      }
    }

    for (var _i = 0; _i < 5; _i++) {
      console.log(totalPerMonth[_i]);
    }
  };
  ...
  _proto.render = function render() {
    ...
    this.getDistinctExpenses(); //this.getTotalMonthlyChangePrediction();
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", (_React$createElement3 = {
      ...
      lineNumber: 88,
      columnNumber: 5
    }, _React$createElement3), this.state.distinctExpenses.map(function (expense) {
      var _React$createElement;
      ...
      lineNumber: 92,
      columnNumber: 25
    }, _React$createElement2), this.state.distinctExpenses.length));
  };
...
//# sourceMappingURL=projections-794552a7a4fe33b8902e.js.map